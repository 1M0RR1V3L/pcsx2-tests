...
class TestPCSX2Graphics:
    ...
    def test_ct010_resolution_5k_gameplay(self):
        """CT008: Aumento de resolução para 5k/8x"""
        ...
        if not self.find_and_click("reso_native_ps2.png", "Dropdown Resolução", offset_y=5):
        ...
        # timeout maior pois a resolução em placa de video integrada diminui drasticamente o fps, logo fica mais lento
        self.skip_intros_aggressively("ben_press_start.png", "Menu Principal", timeout=48)

        print("TESTE 5K CONCLUÍDO.")